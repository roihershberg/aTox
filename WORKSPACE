...
maven_install(
    artifacts = DAGGER_ARTIFACTS + [
        ...
        "androidx.databinding:databinding-adapters:7.1.3",
        "androidx.databinding:databinding-common:7.1.3",
        "androidx.databinding:databinding-runtime:7.1.3",
        ...
        "androidx.room:room-testing:2.4.2",
        "androidx.test.ext:junit:1.1.2",
        "com.google.android.material:material:1.4.0",
        "com.google.code.gson:gson:2.9.0",
        "com.google.guava:guava:19.0",
        "com.squareup.picasso:picasso:2.8",
        "com.typesafe.scala-logging:scala-logging_2.11:3.9.4",
